...
<article id="post-<?php the_ID(); ?>" <?php post_class('freelancer-single v3'); ?>>
	
	<?php echo WP_Freeio_Template_Loader::get_template_part( 'single-freelancer/header-breadcrumbs' ); ?>
			...
			<div class="col-12 list-content-freelancer list-content-service col-lg-<?php echo esc_attr( is_active_sidebar( 'freelancer-single-sidebar' ) ? 8 : 12); ?>">
				<div class="content-main-service content-main-freelancer">
					...
					<div class="top-info-freelancer">
						<?php echo WP_Freeio_Template_Loader::get_template_part( 'single-freelancer/header-v3' ); ?>
