...
<form method="get" action="<?php echo WP_Freeio_Mixes::get_freelancers_page_url(); ?>" class="filter-freelancer-form filter-listing-form vertical filter-listing-form-wrapper">
	
	<?php $fields = WP_Freeio_Freelancer_Filter::get_fields(); ?>
