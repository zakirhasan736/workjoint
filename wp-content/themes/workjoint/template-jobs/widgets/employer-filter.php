...
<form method="get" action="<?php echo WP_Freeio_Mixes::get_employers_page_url(); ?>" class="filter-employer-form filter-listing-form vertical filter-listing-form-wrapper">
	
	<?php $fields = WP_Freeio_Employer_Filter::get_fields(); ?>
