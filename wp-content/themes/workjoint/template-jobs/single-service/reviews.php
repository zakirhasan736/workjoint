...
<div id="reviews">
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="comment-list">
			<?php wp_list_comments( array( 'callback' => array( 'WP_Freeio_Review', 'service_comments' ) ) ); ?>
		</ol>
	...
	<?php if ( get_current_user_id() != $post->post_author && freeio_check_post_review_form($post) ) {
