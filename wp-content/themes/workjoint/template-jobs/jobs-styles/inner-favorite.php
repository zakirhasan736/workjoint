...
<article <?php post_class('map-item job-favorite-wrapper'); ?> <?php freeio_job_item_map_meta($post); ?>>
    <div class="job-item position-relative job-list">
        ...
        <div class="d-md-flex">
            ...
            <div class="action">
                <a href="javascript:void(0);" class="btn-remove-job-favorite" data-job_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-freeio-remove-job-favorite-nonce' )); ?>"><i class="flaticon-delete"></i></a>
            </div>
        </div>
    </div>
</article><!-- #post-## -->
