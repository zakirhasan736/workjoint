...
<div class="job-submission-form-wrapper box-dashboard-wrapper">
	<?php if ( $form_obj->get_form_name() == 'wp_freeio_job_edit_form' ) { ?>
		<h3 class="title"><?php esc_html_e('Edit Job','freeio') ?></h3>
	<?php } else { ?>
		<h3 class="title"><?php esc_html_e('Post a New Job','freeio') ?></h3>
	<?php } ?>
		...
		<?php
			echo cmb2_get_metabox_form( $metaboxes_form, $post_id, array(
				...
				<div class="submit-button-wrapper">
						<button type="submit" name="submit-cmb-job_listing" value="%4$s" class="btn btn-theme">%4$s <i class="flaticon-right-up next"></i></button>
					</div>
				</form>',
