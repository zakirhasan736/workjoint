...
?>
    <div class="widget-service-author">
        ...
        <?php if ( WP_Freeio_Employer::check_restrict_view_contact_info($employer_obj) ) { ?>
            <a href="#apus-contact-form-wrapper" class="btn btn-theme btn-service-contact-form btn-show-popup btn-outline w-100"><?php esc_html_e('Contact Me', 'freeio'); ?><i class="flaticon-right-up next"></i></a>
        <?php } ?>
    </div>
    <?php if ( WP_Freeio_Employer::check_restrict_view_contact_info($employer_obj) ) { ?>
