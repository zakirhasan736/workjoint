...
class Freeio_Widget_Search extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_search',
            esc_html__('Apus Search Widget', 'freeio'),
            array( 'description' => esc_html__( 'Show search form in sidebar', 'freeio' ), )
        );
...
call_user_func( implode('_', array('register', 'widget') ), 'Freeio_Widget_Search' );
