...
class Freeio_Elementor_Widget_Job_Archive_Sortby extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_job_archive_sortby';
	}

	public function get_title() {
		return esc_html__( 'Job Archive:: Sort By', 'freeio' );
	}

	public function get_categories() {
		return [ 'freeio-job-archive-elements' ];
	}
	...
	protected function render() {
		...
		?>
		<div class="jobs-ordering-wrapper wrapper-ordering-listing <?php echo esc_attr($el_class); ?>">
			<form class="jobs-ordering jobs-ordering" method="get" action="<?php echo WP_Freeio_Mixes::get_jobs_page_url(); ?>">
				<?php if ( $title ) { ?>
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Job_Archive_Sortby );
