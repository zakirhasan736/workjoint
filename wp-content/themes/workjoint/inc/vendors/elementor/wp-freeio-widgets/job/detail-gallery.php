...
class Freeio_Elementor_Widget_Detail_Job_Gallery extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_job_gallery';
	}

	public function get_title() {
		return esc_html__( 'Job Details:: Gallery', 'freeio' );
	}
		...
		if ( !empty($post) ) {
			...
			<div class="detail-gallery <?php echo esc_attr($el_class); ?>">
				<?php
		            ...
		            echo WP_Freeio_Template_Loader::get_template_part( 'single-job_listing/photos', $args );
				?>
			</div>
			<?php
			if ( !freeio_is_job_single_page() ) {
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Job_Gallery );
