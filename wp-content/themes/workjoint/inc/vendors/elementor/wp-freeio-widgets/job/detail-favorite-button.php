...
class Freeio_Elementor_Widget_Detail_Job_Favorite_Button extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_job_favorite_button';
	}

	public function get_title() {
		return esc_html__( 'Job Details:: Favorite Button', 'freeio' );
	}
	...
	protected function render() {
		...
		if ( !empty($post_id) ) {
	        ?>
			<div class="job-detail-favorite action-item <?php echo esc_attr($el_class); ?>">
				<?php
			        echo WP_Freeio_Favorite::display_job_favorite_btn($post_id, array(
                        'show_text' => $show_text,
                        'tooltip' => true,
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Job_Favorite_Button );
