...
class Freeio_Elementor_Widget_Detail_Freelancer_Gallery extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_freelancer_gallery';
	}

	public function get_title() {
		return esc_html__( 'Freelancer Details:: Gallery', 'freeio' );
	}
		...
		if ( !empty($post) ) {
			...
			<div class="detail-gallery <?php echo esc_attr($el_class); ?>">
				<?php
		            ...
		            echo WP_Freeio_Template_Loader::get_template_part( 'single-freelancer/gallery', $args );
				?>
			</div>
			<?php
			if ( !freeio_is_freelancer_single_page() ) {
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Freelancer_Gallery );
