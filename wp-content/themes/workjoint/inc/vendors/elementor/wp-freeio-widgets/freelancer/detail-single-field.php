...
class Freeio_Elementor_Widget_Detail_Freelancer_Single_Field extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_freelancer_single_field';
	}

	public function get_title() {
		return esc_html__( 'Freelancer Details:: Single Field Data', 'freeio' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'       => true,
                'condition' => [
                    'show_field' => array('_freelancer_category', '_freelancer_location', '_freelancer_tag'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .freelancer-detail-field, {{WRAPPER}} .freelancer-detail-field a' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .freelancer-detail-field',
            ]
        );
	...
	protected function render() {
		...
		if ( !empty($post_id) ) {
			...
			?>
			<div class="freelancer-detail-field <?php echo esc_attr($el_class.' '.$style); ?>">
				<?php
				$value_html = '';
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Freelancer_Single_Field );
