...
class Freeio_Elementor_Widget_Dashboard_Freelancer_Service_Completed_Count extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_dashboard_freelancer_service_completed_count';
	}

	public function get_title() {
		return esc_html__( 'Freelancer Dashboard:: Service Completed Count', 'freeio' );
	}
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Dashboard_Freelancer_Service_Completed_Count );
