...
class Freeio_Elementor_Widget_Freelancer_Archive_Sortby extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_freelancer_archive_sortby';
	}

	public function get_title() {
		return esc_html__( 'Freelancer Archive:: Sort By', 'freeio' );
	}
	...
	protected function render() {
		...
		$orderby_options = apply_filters( 'wp-freeio-freelancers-orderby', array(
		...
		?>
		<div class="wrapper-ordering-listing freelancers-ordering-wrapper <?php echo esc_attr($el_class); ?>">
			<form class="freelancers-ordering jobs-ordering" method="get" action="<?php echo WP_Freeio_Mixes::get_freelancers_page_url(); ?>">
				<?php if ( $title ) { ?>
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Freelancer_Archive_Sortby );
