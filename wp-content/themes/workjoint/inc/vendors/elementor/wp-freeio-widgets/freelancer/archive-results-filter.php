...
class Freeio_Elementor_Widget_Freelancer_Archive_Results_Filter extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_freelancer_archive_results_filter';
	}

	public function get_title() {
		return esc_html__( 'Freelancer Archive:: Results Filter', 'freeio' );
	}
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Freelancer_Archive_Results_Filter );
