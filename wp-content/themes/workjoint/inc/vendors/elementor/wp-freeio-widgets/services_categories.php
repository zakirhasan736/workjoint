...
class Freeio_Elementor_Freeio_Service_Categories extends Elementor\Widget_Base {

	public function get_name() {
        return 'apus_element_service_categories';
    }

	public function get_title() {
        return esc_html__( 'Apus Service Categories', 'freeio' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'style7' => esc_html__('Style 7', 'freeio'),
                ),
                'default' => 'style1'
            ]
        );
        ...
        $this->add_control(
            'navigation_style',
            [
                'label' => esc_html__( 'Style Navigation', 'freeio' ),
                'type' => Elementor\Controls_Manager::SELECT,
                'options' => array(
                    '' => esc_html__('Default', 'freeio'),
                    'st_bottom' => esc_html__('Bottom', 'freeio'),
                ),
                'default' => '',
                'condition' => [
                    'show_nav' => 'true',
        ...
        $this->add_control(
            'heading_info_options',
            [
                'label' => esc_html__( 'Heading', 'freeio' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .top-widget-info .des' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .view_more .btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->start_controls_tabs( 'tabs_icons_style' );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Elementor\Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .banner-image' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Elementor\Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .category-banner-inner:hover .banner-image::before' => 'background-color: {{VALUE}};',
                    ],
                ]
            );
        ...
        $this->add_control(
            'title_hv_color',
            [
                'label' => esc_html__( 'Title Hover Color', 'freeio' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'number_hv_color',
            [
                'label' => esc_html__( 'Number Hover Color', 'freeio' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'des_hv_color',
            [
                'label' => esc_html__( 'Description Hover Color', 'freeio' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .category-banner-inner:hover .des' => 'color: {{VALUE}};',
                ],
            ]
        );
	...
	protected function render() {
        ...
        ?>
            <div class="widget-service-categories <?php echo esc_attr($el_class); ?>">
                ...
                ?>
                    <div class="slick-carousel <?php echo ( ( $columns >= count($categories))?'hidden-dots':'' ); ?> <?php echo esc_attr( $fullscreen ? 'fullscreen' : '' ); ?> <?php echo esc_attr($navigation_style); ?>"
                        ...
                        <?php foreach ($categories as $item) {
                            $term = get_term_by( 'slug', $item['slug'], 'service_category' );
                ...
                <?php } else { ?>
                    <div class="row">
                        ...
                        <?php foreach ($categories as $item) {
                            ...
                            ?>
                            <div class="col-lg-<?php echo esc_attr($mdcol); ?> col-tablet-extra-<?php echo esc_attr($columns_tablet_extra); ?> col-md-<?php echo esc_attr($smcol); ?> col-<?php echo esc_attr( $xscol ); ?> list-item">
                                <a class="category-banner-inner <?php echo esc_attr($style); ?>" href="<?php echo esc_url($link); ?>">
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Freeio_Elementor_Freeio_Service_Categories );
} else {
    Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Freeio_Service_Categories );
}