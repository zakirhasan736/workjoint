...
class Freeio_Elementor_Widget_Detail_Employer_Private_Message_Button extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_employer_private_message_button';
	}

	public function get_title() {
		return esc_html__( 'Employer Details:: Private Message Button', 'freeio' );
	}
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Employer_Private_Message_Button );
