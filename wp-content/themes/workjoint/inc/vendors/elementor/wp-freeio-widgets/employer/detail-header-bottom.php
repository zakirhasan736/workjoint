...
class Freeio_Elementor_Widget_Detail_Employer_Header_Bottom extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_employer_header_bottom';
	}

	public function get_title() {
		return esc_html__( 'Employer Details:: Header Bottom', 'freeio' );
	}
	...
	protected function render() {
		...
		if ( $post ) {
			?>
			<div class="employer-detail-header-bottom <?php echo esc_attr($el_class); ?>">
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Employer_Header_Bottom );
