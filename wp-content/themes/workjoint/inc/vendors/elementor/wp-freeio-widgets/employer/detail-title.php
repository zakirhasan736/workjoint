...
class Freeio_Elementor_Widget_Detail_Employer_Title extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_employer_title';
	}

	public function get_title() {
		return esc_html__( 'Employer Details:: Title', 'freeio' );
	}
	...
	protected function render() {
		...
		if ( $post ) {
			?>
			<div class="d-flex employer-detail-title-wrapper <?php echo esc_attr($el_class); ?>">
				<?php
				$this->add_render_attribute( 'title', 'class', 'employer-detail-title' );
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Employer_Title );
