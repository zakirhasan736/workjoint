...
class Freeio_Elementor_Widget_Detail_Employer_Jobs extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_employer_jobs';
	}

	public function get_title() {
		return esc_html__( 'Employer Details:: Open Jobs', 'freeio' );
	}
	...
	protected function render() {
		...
		if ( !empty($post) ) {
	        ?>
			<div class="widget-jobs <?php echo esc_attr($el_class); ?>">
                <?php
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Employer_Jobs );
