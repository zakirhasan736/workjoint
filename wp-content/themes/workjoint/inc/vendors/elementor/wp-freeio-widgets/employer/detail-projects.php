...
class Freeio_Elementor_Widget_Detail_Employer_Projects extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_employer_projects';
	}

	public function get_title() {
		return esc_html__( 'Employer Details:: Projects', 'freeio' );
	}
	...
	protected function render() {
		...
		if ( !empty($post) ) {
	        ?>
			<div class="widget-projects <?php echo esc_attr($el_class); ?>">
                <?php
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Employer_Projects );
