...
class Freeio_Elementor_Widget_Service_Archive_Sortby extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_service_archive_sortby';
	}

	public function get_title() {
		return esc_html__( 'Service Archive:: Sort By', 'freeio' );
	}
	...
	protected function render() {
		...
		?>
		<div class="wrapper-ordering-listing services-ordering-wrapper <?php echo esc_attr($el_class); ?>">
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Service_Archive_Sortby );
