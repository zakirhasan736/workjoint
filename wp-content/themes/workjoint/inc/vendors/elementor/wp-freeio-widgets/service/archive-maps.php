...
class Freeio_Elementor_Widget_Service_Archive_Maps extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_service_archive_maps';
	}

	public function get_title() {
		return esc_html__( 'Service Archive:: Maps', 'freeio' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} #services-google-maps' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
	...
	protected function render() {
        ...
        extract( $settings );
		?>
		<div class="service-maps <?php echo esc_attr($el_class); ?>">
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Service_Archive_Maps );
