...
class Freeio_Elementor_Widget_Detail_Service_Overview extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_service_overview';
	}

	public function get_title() {
		return esc_html__( 'Service Details:: Overview', 'freeio' );
	}
	...
	protected function register_controls() {
		...
		$all_fields = $this->get_service_fields();
	...
	protected function render() {
		...
		if ( !empty($post_id) && !empty($items) ) {
			$all_fields = $this->get_service_fields();
			?>
			<div class="service-detail-detail <?php echo esc_attr($el_class); ?>">
	...
	private function render_meta_field($item, $post_id, $field_name) {
		...
		$taxs_real = array('_service_category' => 'service_listing_category', '_service_location' => 'location', '_service_tag' => 'service_listing_tag');
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Service_Overview );
