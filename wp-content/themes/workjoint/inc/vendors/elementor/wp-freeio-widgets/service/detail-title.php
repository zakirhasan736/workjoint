...
class Freeio_Elementor_Widget_Detail_Service_Title extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_service_title';
	}

	public function get_title() {
		return esc_html__( 'Service Details:: Title', 'freeio' );
	}
	...
	protected function render() {
		...
		if ( $post_id ) {
			...
			<div class="title-wrapper d-flex <?php echo esc_attr($el_class); ?>">
				<?php
				$this->add_render_attribute( 'title', 'class', 'service-detail-title' );
				...
				?>
				<span class="flex-shrink-0"><?php freeio_service_display_featured_icon($post,'icon'); ?></span>
			</div>
			<?php
		}
	}
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Service_Title );
