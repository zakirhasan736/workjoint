...
class Freeio_Elementor_Widget_Detail_Project_Title extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_project_title';
	}

	public function get_title() {
		return esc_html__( 'Project Details:: Title', 'freeio' );
	}
	...
	protected function render() {
		...
		if ( $post_id ) {
			?>
			<div class="title-wrapper d-flex <?php echo esc_attr($el_class); ?>">
				<?php
				$this->add_render_attribute( 'title', 'class', 'project-detail-title' );
				...
				?>
				<span class="flex-shrink-0"><?php freeio_project_display_featured_icon($post,'icon'); ?></span>
			</div>
			<?php
		}
	}
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Project_Title );
