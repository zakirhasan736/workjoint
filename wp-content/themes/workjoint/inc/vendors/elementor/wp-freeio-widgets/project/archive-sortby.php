...
class Freeio_Elementor_Widget_Project_Archive_Sortby extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_project_archive_sortby';
	}

	public function get_title() {
		return esc_html__( 'Project Archive:: Sort By', 'freeio' );
	}
	...
	protected function render() {
		...
		?>
		<div class="wrapper-ordering-listing projects-ordering-wrapper <?php echo esc_attr($el_class); ?>">
			<form class="projects-ordering jobs-ordering" method="get" action="<?php echo WP_Freeio_Mixes::get_projects_page_url(); ?>">
				<?php if ( $title ) { ?>
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Project_Archive_Sortby );
