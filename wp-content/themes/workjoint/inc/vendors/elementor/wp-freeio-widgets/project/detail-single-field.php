...
class Freeio_Elementor_Widget_Detail_Project_Single_Field extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_project_single_field';
	}

	public function get_title() {
		return esc_html__( 'Project Details:: Single Field Data', 'freeio' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .project-detail-field, {{WRAPPER}} .project-detail-field a' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .project-detail-field',
            ]
        );
	...
	protected function render() {
		...
		if ( !empty($post_id) ) {
			...
			?>
			<div class="project-detail-field <?php echo esc_attr($el_class.' '.$style); ?>">
				<?php
				$value_html = '';
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Project_Single_Field );
