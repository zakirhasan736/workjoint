...
class Freeio_Elementor_Widget_Detail_Project_Related extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_project_related';
	}

	public function get_title() {
		return esc_html__( 'Project Details:: Related', 'freeio' );
	}
	        ...
	        ?>
				...
				if( $loop->have_posts() ):
                    ...
                    <div class="wrapper-services-related related-detail-listing <?php echo esc_attr($el_class); ?>">
    		            <div class="related-posts <?php echo esc_attr($layout_type.' item-'.$project_item_style); ?> <?php echo esc_attr($el_class); ?>">
...
Elementor\Plugin::instance()->widgets_manager->register( new Freeio_Elementor_Widget_Detail_Project_Related );
